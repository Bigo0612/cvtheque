<div> class="Mentions-légales">
    ...
    <div class="wrap">
        <p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il
            est précisé aux utilisateurs du site <a href="http://CVTEK/">CVTEK</a> l'identité des
        ...
        <p><strong>Propriétaire</strong> : N'FactorySchool – Indépendant – 28 Place Saint-Marc, 76000 Rouen<br/>
            <strong>Créateur</strong> : <a href="www.CVTEK.com">FrédericMichel</a><br/>
    ...
    <div class="wrap">
        <p>L’utilisation du site <a href="http://CVTEK/">CVTEK</a> implique l’acceptation pleine et
            ...
            <a href="http://CVTEK/">CVTEK</a> sont donc invités à les consulter de manière
            régulière.</p>
        ...
        <p>Le site <a href="http://CVTEK/">CVTEK</a> est mis à jour régulièrement par Michel. De la
    ...
    <div class="wrap">
        <p>Le site <a href="http://CVTEK/">CVTEK</a> a pour objet de fournir une information
            concernant l’ensemble des activités de la société.</p>
        <p>Curriculum Factory s’efforce de fournir sur le site <a href="http://CVTEK/">CVTEK</a> des
        ...
        <p>Tous les informations indiquées sur le site <a href="http://CVTEK/">CVTEK</a> sont données
            à titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant sur le site
            <a href="http://CVTEK/">Curriculum Factory</a> ne sont pas exhaustifs. Ils sont donnés sous
    ...
    <div class="wrap">
        ...
        <p>N'FactorySchool ne pourra également être tenue responsable des dommages indirects (tels par exemple qu’une
            perte de marché ou perte d’une chance) consécutifs à l’utilisation du site <a href="http://CVTEK/">CVTEK</a>.
        </p>
    ...
    <div class="wrap">
        <p>En France, les données personnelles sont notamment protégées par la loi n° 78-87 du 6 janvier 1978, la loi n°
            ...
            1995.</p>
        <p>A l'occasion de l'utilisation du site <a href="http://CVTEK/">CVTEK</a>, peuvent êtres
            recueillies : l'URL des liens par l'intermédiaire desquels l'utilisateur a accédé au site <a
                href="http://CVTEK/">CVTEK</a>, le fournisseur d'accès de l'utilisateur, l'adresse
        ...
        <p> En tout état de cause N'FactorySchool ne collecte des informations personnelles relatives à l'utilisateur
            ...
            <a href="http://CVTEK/">CVTEK</a>. L'utilisateur fournit ces informations en toute
            connaissance de cause, notamment lorsqu'il procède par lui-même à leur saisie. Il est alors précisé à
            l'utilisateur du site <a href="http://CVTEK/">CVTEK</a> l’obligation ou non de fournir ces
            informations.</p>
        ...
        <p>Aucune information personnelle de l'utilisateur du site <a href="http://CVTEK/">CVTEK</a>
            ...
            et de modification des données vis à vis de l'utilisateur du site <a href="http://CVTEK/">CVTEK</a>.
        </p>
    ...
    <div class="wrap">
        <p>Le site <a href="http://CVTEK/">CVTEK</a> contient un certain nombre de liens hypertextes
        ...
        <p>La navigation sur le site <a href="http://CVTEK/">CVTEK</a> est susceptible de provoquer
    ...
    <div class="wrap">
        <p>Tout litige en relation avec l’utilisation du site <a href="http://CVTEK/">CVTEK</a> est
