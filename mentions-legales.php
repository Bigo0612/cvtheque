...
<div class="Mentions-légales">
    ...
    <div class="wrap">
        <p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il
            est précisé aux utilisateurs du site <a href="http://CurriculumFactory/">Curriculum Factory</a> l'identité des
            différents intervenants dans le cadre de sa réalisation et de son suivi :</p>
        <p><strong>Propriétaire</strong> : N'FactorySchool – Indépendant – 28 Place Saint-Marc, 76000 Rouen<br/>
            <strong>Créateur</strong> : <a href="www.CurriculumFactory.com">FrédericMichel</a><br/>
            <strong>Responsable publication</strong> : Michel – Michel@gmail.com<br/>
            Le responsable publication est une personne physique ou une personne morale.<br/>
            <strong>Webmaster</strong> : FredericMichel – FredericMichel@gmail.com<br/>
            <strong>Hébergeur</strong> : N'factory School – 28 Place Saint-Marc, 76000 Rouen<br/>
            Crédits : Thibault
            Steve
            Axel
            Antonin
            ...
            Le modèle de mentions légales est offert par Subdelirium.com <a target="_blank"
                                                                            ...
                                                                            alt="Modèle de mentions légales">Modèle de
    ...
    <div class="wrap">
        <p>L’utilisation du site <a href="http://CurriculumFactory/">Curriculum Factory</a> implique l’acceptation pleine et
            ...
            susceptibles d’être modifiées ou complétées à tout moment, les utilisateurs du site <a
                    href="http://CurriculumFactory/">Curriculum Factory</a> sont donc invités à les consulter de manière
            régulière.</p>
        <p>Ce site est normalement accessible à tout moment aux utilisateurs. Une interruption pour raison de
            maintenance technique peut être toutefois décidée par Curriculum Factory, qui s’efforcera alors de communiquer
            préalablement aux utilisateurs les dates et heures de l’intervention.</p>
        <p>Le site <a href="http://CurriculumFactory/">Curriculum Factory</a> est mis à jour régulièrement par Michel. De la
    ...
    <div class="wrap">
        <p>Le site <a href="http://CurriculumFactory/">Curriculum Factory</a> a pour objet de fournir une information
            concernant l’ensemble des activités de la société.</p>
        <p>Curriculum Factory s’efforce de fournir sur le site <a href="http://CurriculumFactory/">Curriculum Factory</a> des
        ...
        <p>Tous les informations indiquées sur le site <a href="http://CurriculumFactory/">Curriculum Factory</a> sont données
            à titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant sur le site <a
                    href="http://CurriculumFactory/">Curriculum Factory</a> ne sont pas exhaustifs. Ils sont donnés sous
    ...
    <div class="wrap">
        <p>N'FactorySchool est propriétaire des droits de propriété intellectuelle ou détient les droits d’usage sur
    ...
    <div class="wrap">
        <p>N'FactorySchool ne pourra être tenue responsable des dommages directs et indirects causés au matériel de
            l’utilisateur, lors de l’accès au site N'FactoryStats, et résultant soit de l’utilisation d’un matériel ne
            répondant pas aux spécifications indiquées au point 4, soit de l’apparition d’un bug ou d’une
            incompatibilité.</p>
        <p>N'FactorySchool ne pourra également être tenue responsable des dommages indirects (tels par exemple qu’une
            perte de marché ou perte d’une chance) consécutifs à l’utilisation du site <a href="http://N'FactoryStats/">N'FactoryStats</a>.
        </p>
        <p>Des espaces interactifs (possibilité de poser des questions dans l’espace contact) sont à la disposition des
            utilisateurs. N'FactorySchool se réserve le droit de supprimer, sans mise en demeure préalable, tout contenu
            déposé dans cet espace qui contreviendrait à la législation applicable en France, en particulier aux
            dispositions relatives à la protection des données. Le cas échéant, N'FactorySchool se réserve également la
    ...
    <div class="wrap">
        <p>En France, les données personnelles sont notamment protégées par la loi n° 78-87 du 6 janvier 1978, la loi n°
            ...
            1995.</p>
        <p>A l'occasion de l'utilisation du site <a href="http://CurriculumFactory/">Curriculum Factory</a>, peuvent êtres
            recueillies : l'URL des liens par l'intermédiaire desquels l'utilisateur a accédé au site <a
                    href="http://CurriculumFactory/">Curriculum Factory</a>, le fournisseur d'accès de l'utilisateur, l'adresse
            de protocole Internet (IP) de l'utilisateur.</p>
        <p> En tout état de cause N'FactorySchool ne collecte des informations personnelles relatives à l'utilisateur
            que pour le besoin de certains services proposés par le site <a
                    href="http://CurriculumFactory/">Curriculum Factory</a>. L'utilisateur fournit ces informations en toute
            connaissance de cause, notamment lorsqu'il procède par lui-même à leur saisie. Il est alors précisé à
            l'utilisateur du site <a href="http://CurriculumFactory/">Curriculum Factory</a> l’obligation ou non de fournir ces
            informations.</p>
        <p>Conformément aux dispositions des articles 38 et suivants de la loi 78-17 du 6 janvier 1978 relative à
            ...
            à laquelle la réponse doit être envoyée.</p>
        <p>Aucune information personnelle de l'utilisateur du site <a href="http://CurriculumFactory/">Curriculum Factory</a>
            n'est publiée à l'insu de l'utilisateur, échangée, transférée, cédée ou vendue sur un support quelconque à
            des tiers. Seule l'hypothèse du rachat de N'FactorySchool et de ses droits permettrait la transmission des
            dites informations à l'éventuel acquéreur qui serait à son tour tenu de la même obligation de conservation
            et de modification des données vis à vis de l'utilisateur du site <a href="http://CurriculumFactory/">Curriculum Factory</a>.
        </p>
    ...
    <div class="wrap">
        <p>Le site <a href="http://CurriculumFactory/">Curriculum Factory</a> contient un certain nombre de liens hypertextes
            vers d’autres sites, mis en place avec l’autorisation de N'FactorySchool. Cependant, N'FactorySchool n’a pas
            la possibilité de vérifier le contenu des sites ainsi visités, et n’assumera en conséquence aucune
            responsabilité de ce fait.</p>
        <p>La navigation sur le site <a href="http://CurriculumFactory/">Curriculum Factory</a> est susceptible de provoquer
            l’installation de cookie(s) sur l’ordinateur de l’utilisateur. Un cookie est un fichier de petite taille,
            qui ne permet pas l’identification de l’utilisateur, mais qui enregistre des informations relatives à la
            navigation d’un ordinateur sur un site. Les données ainsi obtenues visent à faciliter la navigation
            ultérieure sur le site, et ont également vocation à permettre diverses mesures de fréquentation.</p>
    ...
    <div class="wrap">
        <p>Tout litige en relation avec l’utilisation du site <a href="http://CurriculumFactory/">Curriculum Factory</a> est
            soumis au droit français. Il est fait attribution exclusive de juridiction aux tribunaux compétents de
            Paris.</p>
    </div>
